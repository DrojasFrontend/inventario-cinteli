firebase.initializeApp({
  apiKey: "AIzaSyCre-FmneNkGz9Cja4GH5KIv8mEaow4oio",
  authDomain: "inventario-8.firebaseapp.com",
  databaseURL: "https://inventario-8.firebaseio.com",
  projectId: "inventario-8",
  storageBucket: "inventario-8.appspot.com",
  messagingSenderId: "777365925864"
});
...
db.collection("PC").onSnapshot(querySnapshot => {
  ...
  querySnapshot.forEach(doc => {
    ...
    <tr id="${doc.id}">
      ...
      <td>
        <button type="button" class="btn btn-danger" onclick="btnRemove('${
          doc.id
    ...
    <div>
      ...
      <table style="width: 100%; max-width: 600px; margin: 0 auto;">
        ...
        <tr>
          ...
          <td style="border: 0; padding: 10px 0 0 0; vertical-align: top;">` +
      this.nit +
      `</td>
        </tr>
        <tr>
      ...
      `</td>
        ...
        <tr>
          ...
          <td style="border:0;padding:10px 0 20px 0;">` +
      this.observations +
      `</td>
        </tr>
        <tr>
